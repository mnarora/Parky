...
router.post("/bookaslot", async (req, res) => {
...
router.post("/editprof/:email", async (req, res) => {
  const email = req.params.email;
...
router.delete("/deleteaccount/:email", async (req, res) => {
  const email = req.params.email;
  await ParkingSpace.find({ email: email })
    .then(spaces => {
      spaces.map(space => {
...
router.post("/bookinghistory/:email", async (req, res) => {
  const email = req.params.email
...
router.post("/myspaces/:email", async (req, res) => {
  const email = req.params.email
...
router.post("/editspace/:id", async (req, res) => {
  const id = req.params.id;
  await ParkingSpace.findById(id)
    .then(space => {
      console.log(space);
...
router.post("/showspaces", async (req, res) => {

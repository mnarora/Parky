...
//         imagePreviewUrl: ''
//     }
//     autoCompleteRef = React.createRef(null);
...
//     handleScriptLoad = async (autoCompleteRef) =>{
//       let autoComplete;
...
//         const qury = addressObject.formatted_address;
//         this.setState({
//             address: qury
//         })
...
//     componentDidUpdate(autoCompleteRef) {
//         this.loadScript(
